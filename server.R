...
output$unemployed <- renderPlot({
  ...
  b <- ggplot(labor_force, aes(x = column3, y =unemployed)) +
    geom_bar(stat = "identity", fill = "navy") +geom_text(aes(label = unemployed),vjust = -0.5) + labs(x ="", y ="unemployed") + theme_bw()+
    labs(title = "")  +
    theme(axis.text.x = element_text(size = 16),
          axis.text.y = element_text(size = 16),
          axis.title.x = element_text(size = 18),
...
output$laboryouth <- renderPlot({
  ...
  q <- ggplot(youth, aes(x = column4, y =laborforce)) +
    geom_bar(stat = "identity", fill = "navy") +geom_text(aes(label = laborforce),vjust = -0.5) + labs(x ="", y ="laborforce") + theme_bw()+
    labs(title = "")  +
    theme(axis.text.x = element_text(size = 16),
          axis.text.y = element_text(size = 16),
          axis.title.x = element_text(size = 18),
